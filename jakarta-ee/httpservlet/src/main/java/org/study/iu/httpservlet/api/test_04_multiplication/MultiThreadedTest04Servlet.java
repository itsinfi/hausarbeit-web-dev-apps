...
@WebServlet(value = "/api/04_multi", asyncSupported = true)
public class MultiThreadedTest04Servlet extends SingleThreadedTest04Servlet implements MultiThreadingTestable {
    @Override
